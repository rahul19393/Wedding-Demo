package wedcraze.acumeet.com.weddingdemo.WheelView;
...
import wedcraze.acumeet.com.weddingdemo.BuildConfig;
...
public class CursorWheelLayout extends ViewGroup {
     ...
     */
    private static final float RADIO_DEFAULT_CHILD_DIMENSION = 1;

    /**
     * size of center item relative to parent
     */
    private static final float RADIO_DEFAULT_CENTER_DIMENSION = 1 / 2f;
    /**
    ...
    private static final
    @ColorInt
    int DEFAULT_WHEEL_BG_COLOR = 0x70ffffff;

    public static final
    @ColorInt
    int DEFAULT_GUIDE_LINE_COLOR = 0x000000;
...
//            }
      ...
      //  cView.setBackgroundDrawable( getResources().getDrawable(R.drawable.whellmain) );
        if (mIsFirstLayout) {
    ...
    private void addMenuItems() {
        ...
        for (int i = 0; i < mMenuItemCount; i++) {
         ...
         //   view.setOnClickListener(new InnerClickListener(i));
            if (mSelectedView == view || mTempSelectedView == view) {
                return;
            }
